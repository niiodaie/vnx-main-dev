...
const directories = [
  ...
  },
  {
    ...
    description: "Directory of African startups and innovation hubs",
...
export default function DirectoriesPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-purple-600 to-violet-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FolderTree className="w-16 h-16 mx-auto mb-6 text-white" />
          <h1 className="text-5xl font-bold text-white mb-6">VNX Directories</h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Discover niche resources by category
          </p>
        </div>
      </section>
